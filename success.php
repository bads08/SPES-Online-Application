        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="alert alert-success alert-dismissible">
                ...
                <h4><i class="icon fa fa-check"></i> Application Successfully Submit!</h4>
                Check your email regularly, we will notify you about the Status of your Application. <a href="profile?profile">View here</a>
              </div>
          </div>
        </div>
      </section>
