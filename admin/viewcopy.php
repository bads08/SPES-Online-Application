    ...
    <section class="content">
      ...
      <div class="box magictime slideRightReturn">
        ...
        <div class="box-body">
              ...
              <div class="row">
                <div class="col-lg-6">
                <h4 class="text-purple">Profile Detail</h4>
              ...
              <tr>
                  ...
                  <td>
                      <span class=""><?php echo date("M d, Y", strtotime($row["date"]))?></span>
                  </td>
              </tr>
              <tr>
                  <th width="30%">Application Status:</th>
                  <td>
                ...
                <div class="col-lg-6">
           <h4 class="text-purple">Other details</h4> 
             <table class="table-condensed">
              <tr>
