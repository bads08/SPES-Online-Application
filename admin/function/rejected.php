...
if ($retquery->num_rows > 0) {
 ...
 if (isset($_POST["id"])) {
     ...
     `application`
             SET
            `application_status` = 'Dis-approved',
            `date_approved` = '$date' 
...
<body>
    <div style="width: 100%;display: flex;justify-content: center; padding: 10px;">
        <table style="font-family:Arial, Helvetica, sans-serif; border-collapse: collapse;width: 50%;">
            ...
            <tr>
                <td style="padding: 10px;font-size: 20px; font-weight: bold;color: rgb(10, 130, 209);background-color: rgb(243, 241, 241);"><center><span>Sorry! Youre application was dis-approved.</span></center></td>
            </tr>
            <tr>
