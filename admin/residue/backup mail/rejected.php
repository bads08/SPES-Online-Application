...
if ($retquery->num_rows > 0) {
 ...
 if (isset($_POST["id"])) {
     ...
     `applicant`
             SET
            `status` = 'Rejected' WHERE `applicant_id` = '$get_id'";
     $query = $con->query($sql);
     //email notification
													...
													<table class="heading_block" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td style="text-align:center;width:100%;">
																<h1 style="margin: 0; color: #333131; direction: ltr; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size: 24px; font-weight: normal; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0;"><strong>Sorry '.$lname.'! your Not Qualified to our SPES Program.</strong></h1>
															</td>
														</tr>
													</table>
															...
															<td>
																<div style="font-family: sans-serif">
																	<div style="font-size: 14px; mso-line-height-alt: 16.8px; color: #555555; line-height: 1.2; font-family: Arial, Helvetica Neue, Helvetica, sans-serif;">
																		<p style="margin: 0; font-size: 14px; text-align: center;">As of our Review youre not qualified to our SPES Program.</p>
																	</div>
																</div>
															</td>
														</tr>
