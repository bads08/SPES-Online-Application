      ...
      <div class="box">
        ...
        <div class="box-body">
          <table id="example2" class="table table-hover">
              ...
              FROM
              requirements
              INNER JOIN applicant ON applicant.applicant_id = requirements.applicant_id
              GROUP BY
              applicant.applicant_id";
              ...
              <tr>
                  ...
                  <td><a class="btn bg-purple btn-sm" href="applicant-pending-view?id=<?php echo $row["applicant_id"]?>"><i class="fa fa-eye"></i> View</a></td>
              </tr>
