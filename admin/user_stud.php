...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="modal fade" id="modal-user-edit">
            ...
            <div class="modal-content">
              ...
              <h3 class="success-delete text-green"></h3>
                <form id="addform" class="hide-delete">
                    ...
                    <input type="text" class="form-control" value="" id="delete-id" name="delete-id">
        ...
        <div class="modal fade" id="modal-student-delete">
          <div class="modal-dialog modal-sm">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              ...
              <h3 class="success-delete text-green"></h3>
                <form id="addform" class="hide-delete">
                    ...
                    <input type="hidden" class="form-control" value="" id="stud-id" name="stud-id">
                    <h3>Proceed to Delete?</h3>
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
                <button type="button" class="btn bg-purple hide-delete" id="delete-stud">Delete</button>
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
...
<script>
 ...
 $("body").on("click",".del-stud", function (e) {
   e.preventDefault();
   let delete_id = $(this).attr("id");
   $.ajax({
     url: "function/stud_get_id_delete.php",
     type: "POST",
     data: {delete_id: delete_id},
     cache: false,
     success: function (resultDel) {
       $("#stud-id").val(resultDel);
     }
   });
 });

 $("#delete-stud").on("click", function (e) {
   e.preventDefault();
   let delete_id = $("#stud-id").val();
   $.ajax({
     url: "function/stud_delete.php",
     type: "POST",
     data: {delete_id: delete_id},
     cache: false,
     success: function (resultDeleted) {
