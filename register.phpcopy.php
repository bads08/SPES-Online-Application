    ...
    <div class="container">
      ...
      <section>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="well">
              <center><h4 class="text-purple">Let's create your Account first</h4></center>
                <br>
                <form action="admin/function/register.php" method="post">
                  ...
                  <br>
                  <div class="form">
                      <input type="submit" name="register" value="Register" class="btn btn-flat bg-purple"><br><br>
