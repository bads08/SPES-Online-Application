...
$mail->addAddress('macalanganbadrodin@gmail.com', 'sample');     //Add a recipient
...
<body>
    <div style="width: 100%;display: flex;justify-content: center; padding: 10px;">
        <table style="font-family:Arial, Helvetica, sans-serif; border-collapse: collapse;width: 50%;">
            ...
            <tr>
                <td style="padding-top: 5px;color: rgb(97, 93, 93);padding-bottom: 10px;background-color: rgb(243, 241, 241);"><center><span>Control No. <strong>'.$_SESSION["control-no"].'</strong></span></center></td>
            </tr>
        </table>
    </div>
</body>
...
echo "sent success";
    ...
    echo "Message could not be sent. Mailer Error: {$mail->ErrorInfo}"." "."<a href='../../home'>Ok</a>";
}
?>